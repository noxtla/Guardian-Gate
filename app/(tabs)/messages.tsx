...
const initialMessages: Message[] = [
  { id: '1', text: "Hello! I'm having an issue with my vehicle's brakes. Can you help?", time: '10:47 PM', isSender: true, avatarSource: AVATARS.user },
  { id: '2', text: 'Hello! I can certainly help with that. Could you please provide the vehicle number?', time: '10:48 PM', isSender: false, avatarSource: AVATARS.support },
];
...
const styles = StyleSheet.create({
  ...
  inputAreaContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.brand.white, paddingTop: 10, paddingHorizontal: 15, borderTopWidth: StyleSheet.hairlineWidth, borderColor: Colors.brand.lightGray },
